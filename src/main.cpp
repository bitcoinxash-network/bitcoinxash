...
#if defined(NDEBUG)
#error "BCX cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 4 * COIN;
	} else if (nHeight < 160000 && nHeight > 80000) {
        nSubsidy = 3 * COIN;
	} else if (nHeight < 320000 && nHeight > 160000) {
        nSubsidy = 2 * COIN;
	} else if (nHeight < 640000 && nHeight > 320000) {
        nSubsidy = 1 * COIN;
	} else if (nHeight < 1280000 && nHeight > 640000) {
        nSubsidy = 0.8 * COIN;
	} else {
        nSubsidy = 1 * COIN;
