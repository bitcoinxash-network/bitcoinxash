...
RESOURCES += src/qt/bcx.qrc src/qt/bcx_locale.qrc

TRANSLATIONS += src/qt/locale/bcx_bg.ts \
                src/qt/locale/bcx_de.ts \
                src/qt/locale/bcx_en.ts \
                src/qt/locale/bcx_es.ts \
                src/qt/locale/bcx_fi.ts \
                src/qt/locale/bcx_fr.ts \
                src/qt/locale/bcx_it.ts \
                src/qt/locale/bcx_ja.ts \
                src/qt/locale/bcx_pl.ts \
                src/qt/locale/bcx_pt.ts \
                src/qt/locale/bcx_ru.ts \
                src/qt/locale/bcx_sk.ts \
                src/qt/locale/bcx_sv.ts \
                src/qt/locale/bcx_vi.ts \
                src/qt/locale/bcx_zh_CN.ts \
                src/qt/locale/bcx_zh_TW.ts
