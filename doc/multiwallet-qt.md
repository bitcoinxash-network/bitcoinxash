...
In order to support loading of multiple wallets in bcx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bcx.cpp.
...
Changes to bcx.cpp
----------------------
bcx.cpp is the entry point into bcx-qt, and as such, will require some minor modifications to provide hooks for
