...
Intro
-----
BCX (BCX) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. BCX utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run bcx-qt.exe.

BCX Core is the original BCX client and it builds the backbone of the network.
However, it downloads and stores the entire history of BCX transactions;
