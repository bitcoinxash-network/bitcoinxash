Contributing to BCX Core
==================================

The BCX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BCX Core project, and is not to be
confused with overall BCX Network Protocol consensus changes.

Whether a pull request is merged into BCX Core rests with the project merge
...
Patches that change BCX consensus rules are considerably more involved than
...
Where a patch set proposes to change the BCX consensus, it must have been
...
The project leader is the release manager for each BCX Core release.
