...
#   c) node1 mines 32 blocks, so now node 0 has 500000BCX, node 1 has 4250BCX, node2 has none.
#   d) node0 sends 601 BCX to node2, in two transactions (301 BCX, then 300 BCX).
